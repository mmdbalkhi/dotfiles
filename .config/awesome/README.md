...
* Terminal kitty
* Theme Powerarrow (Personalized)

Installation
=======

First run the following command to download third-party files

```shell
$ git submodule update --init --recursive
```

Then add your theme in file `rc.lua`
...
If you are interested, overwrite my personalized theme in the `theme.lua` file in the path `themes/themes/powerarrow`

My personalized configuration in the theme:
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#284452"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#284452"),
            arrow("#284452", "#385873"),
            wibox.container.background(wibox.container.margin(wibox.widget { fs_home, theme.fs_home.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#385873"),
            wibox.container.background(wibox.container.margin(wibox.widget { fs_root, theme.fs_root.widget, layout = wibox.layout.align.horizontal }, 3, 6), "#385873"),
            arrow("#385873", "#4C5B83"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#4C5B83"),
            arrow("#4C5B83", "#676A99"),
            ...
            arrow("#AB7696", "#B87B9D"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#B87B9D"),
            arrow("#B87B9D", "#D180A3"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#D180A3"),
            arrow("#D180A3", "alpha"),
            --]]
            s.mylayoutbox,
        },
