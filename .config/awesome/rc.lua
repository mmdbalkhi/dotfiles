...
-- choose your theme here
local theme_path = string.format("%s/.config/awesome/themes/powerarrow/theme.lua", os.getenv("HOME"))
...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " dev ", " trm ", " vid ", " bg "}
...
-- widget creation
mykbd = awful.widget.keyboardlayout()
